...
if(isset($_POST['apply'])){
    ...
    $sql="INSERT INTO user_std(mrms,name,father,gender,jeerank,address,email,phone,department,branch,semester,course,password) VALUES ('$data_mrms', '$data_name','$data_father','$data_gender','$data_jeerank','$data_address','$data_email','$data_phone','$data_department','$data_branch','$data_semester','$data_course','$data_password')";  
