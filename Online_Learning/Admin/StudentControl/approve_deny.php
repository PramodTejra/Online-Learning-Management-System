...
if (isset($_GET['schno_id'])) {
    ...
    $section = $_POST['section'][$scholar_id];
    $insert_sql = "INSERT INTO approve_user 
                   SELECT *, '$section' as section FROM user_std WHERE schno = '$scholar_id'";
...
if (isset($_POST['approve_multiple']) && isset($_POST['selected_students'])) {
    ...
    foreach ($selected_students as $student_id) {
        $section = $_POST['section'][$student_id];
        $sql = "INSERT INTO approve_user 
                SELECT *, '$section' as section FROM user_std WHERE schno = '$student_id' ";
