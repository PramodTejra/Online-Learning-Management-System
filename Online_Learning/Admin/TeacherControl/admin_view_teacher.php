        ...
        <div class="content">
            ...
            <table border="1px">
                ...
                <!-- <td class="table_td"><?php echo "{$info['username']}"; ?></td> -->
                    ...
                    <td class="table_td"><a href="<?php echo "{$info['webpage']}"; ?>" target="_blank"><?php echo "{$info['webpage']}"; ?></a></td>
                    <!-- <td class="table_td"><?php echo "{$info['description']}"; ?></td> -->
                    <td class="table_td"><img height="100px" width="100px" src="https://picsum.photos/500/300" ></td>
                    <td style="padding:20px; text-align: center"><input style="width: 70px;" type="hidden" value="<?php echo "{$info['password']}"; ?>" readonly>****</td>
